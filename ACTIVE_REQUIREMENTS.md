...
- Status: historical SKU display/filter follow-up verified locally after deployed PR-505. Current follow-up GREEN: targeted catalog/BOM/costing/sales/production/inventory Go packages, targeted frontend helper/source tests, frontend build, changed verifier, and diff check. Merge, deploy, API/browser smoke pending.
