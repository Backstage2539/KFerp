...
- Verifier:
  ...
  - GREEN integration/deploy: feature branch pushed; application code fast-forwarded to `origin/develop` at `96ac56800772651a30caeca8573f7eaad9bd648b`; development deployed from the same application commit; final evidence docs fast-forwarded `origin/develop` to `95d466a34ed73b886ffe986c95b2ac4d0f6ebe60` and were synced to the development docs directory; Docker build ran `go test ./...`; server smoke passed for `/app/`, six production Vue routes and `/app/api/production/workstation-overview`.
