...
### Simple Bug Workflow (token-saving exception)

Use this path when Van puts a bug in a "简单BUG" thread/workflow, or when the expected fix is local and self-contained.
