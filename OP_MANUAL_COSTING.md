...
6. 在产品豆单的“豆单版本列表”按“公共豆单”或“所有履约客户豆单”查看版本；需要客户自己的豆单时先在 SKU设置 选择客户并按需开启公共 SKU/公共商品分类引用，再回到产品豆单的生成抽屉选择该客户。
...
- 版本列表的范围下拉只保留“公共豆单”和“所有履约客户豆单”；可再按豆单类型筛选，并从历史版本复制配置生成新版，也可由管理员撤回当前仍在发布状态的版本。
...
- 产品豆单顶部版本列表只用于查看公共豆单和所有履约客户豆单；进入“生成豆单”抽屉后，发布归属默认是棵凡官方豆单，选择“指定客户豆单”并选择客户后，豆单预览和发布保存使用该客户上下文。
