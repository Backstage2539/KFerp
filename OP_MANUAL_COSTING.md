...
- 在“商品分类 · 客户SKU”中打开“是否使用公共商品分类”会复制当前公共商品分类；在“客户SKU列表 · 客户 SKU”中打开“是否使用公共SKU”会复制当前公共 SKU。复制出的客户 SKU 保留公共 SKU 原名；旧库的 `products.name` 全局唯一约束会由系统启动修复移除，避免 `products_name_key` 冲突。
