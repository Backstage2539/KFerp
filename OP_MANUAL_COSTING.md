...
6. 在产品设置 -> 价格与豆单的“豆单版本列表”查看官方、我的客户豆单或指定客户豆单版本；需要客户自己的豆单时先选择客户。
...
## 豆单版本
- 每次发布豆单都会生成一条已发布版本，版本号、配置、内容、归属客户、发布时间和更新说明都保留在产品设置 -> 价格与豆单的“豆单版本列表”中。
...
- 已发布豆单版本列表在产品设置 -> 价格与豆单中可追溯，每个版本的 PDF 缓存只生成一次。
- 发布后商品档案、录单或报价使用新价格。
