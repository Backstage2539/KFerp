...
- 需要查看或初始化客户SKU时，在“SKU归属”里选择客户；选择列表包含所有启用客户，无专属 SKU 的客户也可以先复制公共配置。
- 选中客户后，“新增公共产品”隐藏；客户专属 SKU 使用顶部已选客户，不再在表单里重复选择客户。
- 在“商品分类 · 客户SKU”和“客户SKU列表 · 客户 SKU”中开启“是否使用公共SKU / 是否使用公共商品分类”并点击“复制公共配置”，系统会把当前公共 SKU 和公共商品分类复制成该客户自己的 SKU/分类，已存在的基础 SKU 不重复创建。
