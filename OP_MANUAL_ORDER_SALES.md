...
- 商品明细标题区点击“选择豆单”打开豆单选择抽屉，可按熟豆豆单、生豆豆单、挂耳豆单分别选择已发布版本。客户有某类型专属豆单时可选不同已发布版本，默认最新；客户没有专属豆单时该类型使用公共豆单，也可以选择公共豆单历史发布版本，默认最新公共豆单。
...
- PR-345-ORDER-CUSTOMER-PROFILE-BEANLIST-DRAWER：订单信息中的客户类型、来源和订单类型与客户资料一致；商品明细“选择豆单”抽屉中选定的熟豆、生豆、挂耳豆单版本被用于本次订单，客户无专属豆单时显示公共豆单。
