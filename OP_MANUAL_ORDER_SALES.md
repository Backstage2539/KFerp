...
- 订单列表“金额”列展开显示商品金额、运费、优惠和应收；如果订单记录了快递费说明或委外总费用，也会在同一列显示。
...
- 价格不符合预期：检查商品价格、成本发布记录、规格是否有专属梯度、总重量折算磅数或 KG 数是否落在预期梯度内，以及当前单价单位是元/磅还是元/kg。曲奇拼配这类 KG 梯度产品要按总 KG 核对。
