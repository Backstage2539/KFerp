...
12. 需要回到全局订单、生产计划/开始生产、全局库存、门户能力、公司设置、员工权限或需求表时，内部员工切回“工厂总览”。
13. PR-314-SHELL-MENU-SCROLL-TOUCH：左侧菜单固定在单屏视口内独立滚动，右侧功能页面独立滚动；点击任何功能菜单后功能页面回到顶部。手机端右滑呼出功能菜单，左滑隐藏功能菜单。
