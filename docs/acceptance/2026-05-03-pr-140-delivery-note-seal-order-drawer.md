# PR-140 出库单公章设置与订单抽屉验收记录

日期：2026-05-03

## 需求对应

- PR-140：出库单公章设置和订单抽屉优化。
- DEV-140-01：出库单预览和 PDF 复用共享公章资产、坐标和透明背景处理，并提供出库单页公章设置入口用于上传、选择和去背景。
- DEV-140-02：订单列表收窄为关键列；点击订单打开抽屉展示快递信息和订单状态，并支持单订单回填单号。
