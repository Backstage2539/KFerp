...
- Go/API/仓储测试：`go test ./internal/infrastructure/pdf ./internal/infrastructure/postgres/sales ./internal/infrastructure/postgres/finance ./internal/infrastructure/postgres/catalog ./internal/infrastructure/postgres/bom ./internal/interfaces/http/catalog ./internal/interfaces/http/finance ./internal/interfaces/http/support -run 'TestDev344|TestProductSettingsAPIUpdatesProductName|TestFinanceSourceDetailsIncludesOrderPaymentVoucher|TestSalesOrderPreviewIncludesNoteAndDiscountBreakdowns' -count=1`
