...
func productOptionFromCatalog(p catalogapp.Product) ProductOption {
	out := ProductOption{ID: p.ID, Name: p.Name, DefaultPrice: p.DefaultPrice, RetailPrice100G: p.RetailPrice100G, RetailPrice200G: p.RetailPrice200G, RetailPrice227G: p.RetailPrice227G, RetailPrice250G: p.RetailPrice250G}
