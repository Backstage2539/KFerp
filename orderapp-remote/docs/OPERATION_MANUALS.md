...
- `OP_MANUAL_INVENTORY_MATERIALS.md`：物料、原料入库、批次、库存流水、库存调整、商品档案、客户商品名、商品配置模板、生产 BOM 配方库、BOM 分组和商品生产配置。
- `OP_MANUAL_COSTING.md`：成本参数、成本试算、商品生产配置字段、产品价格表预览、价格表发布、客户商品名价格来源。
