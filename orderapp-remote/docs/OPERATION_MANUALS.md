...
- `OP_MANUAL_CUSTOMER_FULFILLMENT.md`：客户管理与客户履约全流程，覆盖客户档案与共用收件地址、门户能力配置、客户门户能力模板、角色权限、客户开通、客户商品、外部用户登录与工作台隔离、商品价格表页的一件代发/商品下单指定版本、代加工待排产、客户货权库存、订单物流、统一账单和异议处理。
