...
- [小程序员工简易 ERP](OP_MANUAL_MINIAPP_EMPLOYEE_ERP.md)：销售/管理员员工登录、客户维护（按负责人权限）、粘贴收货信息并复用 ERP 地址解析、录单内快捷维护、多商品明细、本人服务器订单草稿、完整订单详情、管理员图片分享入口全局开关，以及销售单/发货单 PDF 与图片微信分享。
...
- `OP_MANUAL_SETTINGS_AUDIT.md`：系统与业务设置、小程序图片分享入口全局开关、部门员工和操作日志。
- `OP_MANUAL_NOTIFICATIONS.md`：通知规则、ERP 站内通知和外部 IM 扩展框架。
- `OP_MANUAL_CUSTOMER_PORTAL.md`：客户门户配置、小程序主题、商城、小程序登录、外部账号关联与 ERP 工作台授权分离、我的豆单、客户自有销售豆单和客户侧入口联调。
