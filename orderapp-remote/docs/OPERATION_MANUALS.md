...
PR-649：生产计划改为“选需求 → 核对缺口 → 安排生产”三步工作台，草稿可保留原计划号修改需求，参见[生产手册](OP_MANUAL_PRODUCTION.md)。

PR-648：生产需求按商品规格归并、独立半成品备货、在途供应与分批入库，参见[生产手册](OP_MANUAL_PRODUCTION.md)和[库存作业手册](OP_MANUAL_STOCK.md)。

PR-639：物料唯一归属、独立复制、BOM 选料和库存货主校验，参见《物料与商品档案手册》《生产管理手册》《库存作业手册》。

PR-635：同版本多张命名价格表的配置、发布与选表下单，参见《成本核价手册》《订单销售手册》《员工小程序 ERP 手册》。
...
- `OP_MANUAL_STOCK.md`：库存作业手册，覆盖 Stock Entry 单据、WIP 领退、工单消耗、物料工单目标仓库与批次完工入库、报废/损耗和库存操作日志。
...
- `OP_MANUAL_CUSTOMER_FULFILLMENT.md`：客户管理与客户履约全流程，覆盖客户档案与共用收件地址、门户能力配置、客户门户能力模板、角色权限、客户开通、客户商品、外部用户登录与工作台隔离、商品价格表页的一件代发/商品下单指定版本、代加工物料与在制产出预订、完工入库转订单批次、客户货权库存、订单物流、统一账单和异议处理。
- PR-668 补齐交付：客户履约手册、客户门户手册、生产手册和库存手册共同覆盖商品配置、生产申请、提前下单、待计划需求、生产工单、完工入库与客户库存的八个界面及跨页追溯。
