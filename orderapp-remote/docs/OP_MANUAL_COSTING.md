...
- PR-439-PRODUCT-PRICE-MASTER-REMODEL：普通商品和客户商品保存不再写入旧模板字段。旧商品配置模板、阶梯价模板、单位模板和分类模板保留为历史兼容或迁移来源，主菜单和客户工作区不再展示这些旧入口；新价格维护从商品价格管理和商品价格表进入。
...
## 客户上下文
- 商品与配方下的商品档案、客户商品、商品分类管理、商品价格管理分别维护执行对象、客户展示对象、组织分类和价格主数据，不再把价格规则塞回商品档案或客户商品。旧商品配置模板、阶梯价模板、单位模板入口不在普通主菜单展示；历史 URL 只用于兼容排查。
