...
6. 生成或发布豆单前确认发布范围：官方豆单用于公共兜底，客户豆单用于指定客户。
7. 确认无误后发布价格或豆单，让录单、报价和客户侧展示使用新版本。
...
## 豆单版本
- 每次发布豆单都会生成一条已发布版本，版本号、配置、内容、归属客户、发布时间和更新说明都保留在版本列表中。
...
- 已发布豆单版本列表可追溯，每个版本的 PDF 缓存只生成一次。
- 发布后商品档案、录单或报价使用新价格。
