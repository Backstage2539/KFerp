...
4. 进入客户履约账户，在“选择客户”中按客户名、公司、联系人或电话搜索客户，并点击载入账户；下拉框只展示已绑定 ERP 履约账号的批发客户。
...
10. 应用后刷新账户，核对托管库存、加工工单、代发订单、费用明细和结算批次。
11. 月结时填写结算开始和结束日期，生成月结后核对结算编号、期间、金额和状态。
12. 客户通过客户门户提交代发或代加工发货订单后，可从订单列表“履约客户订单”范围查看；在客户履约账户载入该客户后，“代发订单”区域也会显示客户门户提交的代发订单。
...
- 客户下拉框只出现已绑定 ERP 履约账号的批发客户，零售、电商和未绑定客户不出现。
...
## 常见问题
- 页面没有客户数据：确认客户档案是否存在、客户是否启用、是否已经在下拉框选择客户并点击载入账户。
