...
- 商品与配方：商品档案、客户商品名、商品配置和分类模板、阶梯价模板、单位模板、生产 BOM、商品价格表、行业字段模板。
...
## 商品管理与商品档案
- PR-395-PRODUCT-PRICE-CLASSIFICATION：商品与配方菜单保持独立入口：`商品档案`、`客户商品名`、`商品配置和分类模板`、`阶梯价模板`、`单位模板`、`生产 BOM`、`商品价格表`、`行业字段模板`。旧手册中“商品管理”表示历史聚合入口；新操作时按这些独立入口进入。
...
- `客户商品名` 只维护客户侧展示名、系统生成的客户商品编号、品牌、排序和是否进入价格表。单个新增和批量添加商品档案时不手工填写客户商品编号；系统自动生成并在列表展示。贴牌、客户命名和客户侧分类变化优先走客户商品名，不复制 BOM，也不在客户商品层修改生产数据。
