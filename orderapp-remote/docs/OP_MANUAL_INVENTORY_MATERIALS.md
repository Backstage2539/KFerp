...
- “商品配置”工作区中，默认维护商品配置模板；点击“阶梯价模板”后维护低频阶梯价档位。商品配置可绑定阶梯价模板、工序模板、价格表生成规则和单位规则。配置完成后回到“商品资料”，在产品子类型行选择“更换商品配置”完成绑定。
- PR-364-SKU-SETTINGS-COMPACT-DRAWERS：商品分类区域变为固定高度滚动窗，可在搜索框输入产品类型、产品子类型或 SKU 名称快速定位。新增或编辑产品类型/产品子类型时，点击“编辑产品类型”打开抽屉；新增公共 SKU 或客户专属 SKU 时，点击客户SKU列表右上角“新增SKU”打开抽屉。
