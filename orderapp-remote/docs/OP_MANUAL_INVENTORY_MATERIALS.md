...
- 工厂／客户视图只改变商品列表和标题，不决定新商品归属。在任一视图点击“创建新商品档案”，都必须在表单中明确选择“工厂公共商品”或“客户专属商品”；客户专属商品还要选择归属客户，可填写客户商品名、客户货号和供料方式。
- 工厂视图展示全部商品，可按档案归属筛选。每行“客户关联”用于把公共商品显式关联给一个或多个客户，并为每个客户单独设置展示名称、货号和供料方式。客户专属商品只能关联其归属客户。客户视图只显示该客户专属商品和已显式关联的公共商品；旧“使用公共商品”开关不再自动放开全部公共商品。
