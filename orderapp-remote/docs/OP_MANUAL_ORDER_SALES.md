...
- PR-343-ORDER-NOTICE-DEDUP-PAYMENT-HINT：录单或编辑订单需要填写收款凭证时，货款金额栏会弹出“货款 金额”的货款提示；点击提示会把当前商品合计填入货款金额，之后仍可按实际收款修改货款。
...
- PR-348-ORDER-ENTRY-BEANLIST-SUMMARY-WARNING：商品明细标题区按行显示当前熟豆、生豆、挂耳豆单，避免长版本信息被省略；选择历史豆单后，行级价格和右侧豆单版本会同步到该版本，并用红色感叹号提示非最新版本。
