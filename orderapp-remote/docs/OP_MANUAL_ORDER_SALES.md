...
- PR-572-MINIAPP-ORDER-DETAIL-DOCUMENT-SHARE：员工小程序订单可进入完整只读详情，并把销售单、发货单分别以 PDF 或图片通过微信分享。
...
- 详情页只读展示网页订单详情中的订单日期、单据日期、客户和收件资料、物流、收款/发货/生产/开票状态、费用合计、商品规格/数量/单价/行总价/条目备注、价格表版本、报价来源、生产来源、责任人、创建人和订单备注；不在小程序中提供编辑、失效、物流回填或生产操作。
