...
## 生产排班与工位自动派工（PR-657，取代 PR-655/656 的逐任务配人）
...
1. 打开工位，在人员区域选择一名启用员工为“主负责人”，再按优先顺序增加零至多名替补。主负责人和替补不能重复；启用工位必须配置主负责人。
...
4. 点击某天某工位，可以从当天上班且属于该工位人员名单的员工中临时换人；“恢复自动安排”删除该日该工位的人工调整，不修改工位配置。
5. 右侧处理未排班、无人值班、失效调整及待交接项。点击“核对并保存排班”后查看受影响工位和任务数量，再保存。页面变脏时离开会提示；并发修改要求重新读取；重复点击不会重复写入。
6. 第一次保存某周排班后，该周自动派工门禁生效。某工位当天没有合格上班人员时显示“无人值班”，新任务不能开工。
...
- 人工调整人员停用、不在工位人员名单或当天不上班时，显示“调整已失效”，需回到排班处理；系统不会静默换人。
