...
## 适用范围
设备产能配置、发货人设置、代加工模板设置、界面设置、部门维护、员工维护、操作日志。

## 入口
- 设置：设备产能配置、发货人设置、代加工模板设置、界面设置
- 档案：部门维护、员工维护
- 日志：操作日志
...
4. 界面设置用于控制账号模式下的菜单入口；“客户账户模式隐藏履约运营台”默认开启，只隐藏客户账户模式里的内部履约运营台入口，不删除履约运营台页面、客户侧工作台或履约 API。
...
## 结果校验
- 设置保存后刷新页面仍能看到最新值。
- 界面设置保存后刷新仍保持开关状态；开启时客户账户模式不显示“履约运营台”，关闭时按原权限显示。
- 相关业务页面使用的是最新配置。
...
- 客户账户模式仍看到履约运营台：进入“设置 / 界面设置”，确认“客户账户模式隐藏履约运营台”已开启，并刷新客户账户模式页面。
