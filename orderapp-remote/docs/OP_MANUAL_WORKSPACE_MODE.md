...
2. 围绕某一个客户连续处理业务时，切到“客户账户”，再在“当前客户”选择器中搜索并选择客户。候选客户只要求客户启用且打开“开通客户门户/工作台”，不要求先维护外部账号、密码或能力模板；没有能力模板时进入空客户视角，具体履约动作仍会被能力校验拒绝。PR-338-CUSTOMER-SELECTOR-CLEAR-DROPDOWN-SPACING：选择器右侧的“清除选择”和“展开候选项”是两个独立按钮，已有客户值时可先清除再重新搜索或展开选择，不会互相重叠。
...
- 顶部“当前客户”已有客户值时，清除选择按钮与下拉按钮分开显示；点击清除后当前客户变为空，可继续输入搜索或点下拉按钮选择客户。
...
- 客户账户选择器没有客户：检查客户是否为启用客户、是否已在客户档案打开“开通客户门户/工作台”。外部账号、密码或能力模板不是进入内部客户账户选择器的前置条件；它们只影响客户外部登录和可用功能。
