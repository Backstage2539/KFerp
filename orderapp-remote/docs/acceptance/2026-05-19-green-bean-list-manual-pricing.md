...
- 生豆豆单手工修改的阶梯价只保存到本次草稿/发布快照；产品豆单预览区提供“保存生豆价格”入口保存当前范围下的生豆草稿。
- 生豆 SKU 未挂到带生豆模板的生豆分类时，预览区提示无法生成生豆价格，并引导去 SKU设置 调整分类。
...
- [x] 产品豆单生豆预览区支持“保存生豆价格”草稿入口；缺少生豆分类模板时显示可操作提示。
