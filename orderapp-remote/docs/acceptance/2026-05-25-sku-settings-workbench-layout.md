...
- 日常商品资料维护和商品配置维护分成两个页内工作区。

## Acceptance
1. 进入 SKU设置 后默认停留在“商品资料”。
2. “商品资料”中可连续看到新增SKU入口、维护商品分类、查看停车场、维护客户SKU列表。
3. 商品分类和客户SKU列表在商品资料工作区中相邻展示；桌面宽度下分类在左、SKU 列表在右，窄屏下上下排列。
4. 切换到“商品配置”后，阶梯价模板和商品配置在同一模板工作区维护。
5. 阶梯价模板和商品配置不再夹在商品分类和客户SKU列表之间。
6. 产品子类型仍在商品资料中通过“商品配置”下拉框选择模板；模板本体的新增、复制和编辑统一在商品配置中完成。
