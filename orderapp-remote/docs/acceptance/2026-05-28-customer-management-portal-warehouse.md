...
- 仓库库存在“当前仓库”摘要行右侧通过“仓库设置”抽屉绑定客户，并写操作日志。
...
- [ ] 仓库库存选择仓库后，点击“仓库设置”打开右侧抽屉，可绑定或解除客户。
- [ ] 仓库库存绑定客户后，门户客户配置详情展示该客户仓库；客户账户库存只显示公共仓库和当前客户绑定仓库，不显示其他客户绑定仓库。
...
- API 测试：`go test ./internal/application/customer ./internal/application/stock ./internal/interfaces/http/customer ./internal/interfaces/http/stock ./internal/interfaces/http/customerportal ./internal/infrastructure/postgres/customerportal ./internal/infrastructure/postgres/stock -count=1`
