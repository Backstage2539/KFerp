...
- 修复商品价格表候选把旧产品分类或父分类上的阶梯价模板当作商品实际阶梯价来源的问题。
- 商品价格表实际阶梯价来源收敛为客户商品规则、客户商品规则模板、商品级覆盖和商品档案引用的商品配置模板。
...
- 商品未绑定商品级阶梯价覆盖、商品配置模板阶梯价或客户规则时，不会因为分类模板/分类项引用阶梯价模板而在商品价格表显示阶梯价。
