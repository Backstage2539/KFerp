...
- [x] 合入 `develop@d81e022b` 并部署后，在已登录开发页面实际发布成功，不再出现“SKU 7 未在规格选择中”；创建价格表 `V3.0.20` / `#109`，初晓 454g 四档保持 53/65/50/46 元/袋。
- [x] 操作日志记录 2026-08-27 00:48:28 刘祎泊发布商用豆单 `V3.0.20`，00:48:29 创建 publication `#109` 的 PDF 资产。
