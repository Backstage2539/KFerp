...
| 排产 | 生产管理 -> 生产计划/开始生产 | 选择要生产的商品，先查看物料需求计划，再确认投料 | 看到缺料、已占用和采购建议；开始后生成 WIP 占用 |
...
1. 查看需要生产的商品。
2. 选择要生产的行。
3. 点击“物料需求计划”，检查需求、WIP 库存、已占用、原料仓库存、缺料和采购建议。
...
| WIP看起来有库存，但开始生产仍提示不足 | WIP 库存可能已被其他工单软占用 | 先看“生产计划 -> 物料需求计划”的已占用和缺料 |
