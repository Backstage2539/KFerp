  ...
  <div class="page">
    ...
    <section class="panel">
      <div class="table-wrap">
        ...
        <table v-else>
          <thead><tr><th>ID</th><th>姓名</th><th>电话</th><th>部门</th><th>状态</th><th>操作</th></tr></thead>
          <tbody>
            <tr v-for="row in employees" :key="row.id">
              ...
              <td><input v-model="row.active" type="checkbox" /></td>
              <td><button class="secondary" type="button" @click="saveEmployee(row)" :disabled="saving">保存</button></td>
            </tr>
