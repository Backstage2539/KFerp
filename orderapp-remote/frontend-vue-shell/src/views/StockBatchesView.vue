  ...
  <div class="page">
    ...
    <section class="panel">
      <div class="table-wrap">
        <table>
          <thead><tr><th>批次号</th><th>类型</th><th>名称</th><th>规格</th><th>来源</th><th>数量(g)</th><th>剩余(g)</th><th>件数</th><th>成本</th><th>质检</th><th>操作人</th><th>时间</th></tr></thead>
          <tbody>
            ...
            <tr v-if="!rows.length"><td colspan="12" class="muted">暂无批次</td></tr>
          </tbody>
        </table>
      </div>
      <PaginationControls
