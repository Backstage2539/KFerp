    ...
    <div class="workspace">
      ...
      <section class="panel table-panel">
        <div class="summary-row">
          ...
          <button v-if="!isCustomerInventoryContext" class="secondary" type="button" @click="openWarehouseSettingsDrawer" :disabled="!selectedWarehouse">
            仓库设置
          </button>
        </div>
