    ...
    <div v-if="traceDrawerOpen" class="drawer-mask" @click.self="traceDrawerOpen = false">
      <aside class="drawer">
        ...
        <div class="trace-search">
          <label><span>成品批次</span><input v-model.trim="traceBatch" placeholder="FP-0000000042" @keyup.enter="loadTrace" /></label>
...
async function loadTrace() {
  ...
  try {
    ...
    if (!batch) throw new Error('请填写成品批次号')
