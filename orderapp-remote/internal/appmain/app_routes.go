...
func registerAppRoutes(e *echo.Echo, pool *pgxpool.Pool, cfg appConfig) {
	...
	customerfulfillmenthttp.RegisterRoutes(e, customerfulfillmenthttp.Dependencies{CustomerFulfillment: customerFulfillmentSvc, Customers: customerSvc, MessageCenter: messageCenterSvc, Sales: salesSvc, SharedProcessing: customerPortalSvc})
	...
	saleshttp.RegisterRoutes(e, saleshttp.Dependencies{Authz: authzSvc, Sales: salesSvc, MessageCenter: messageCenterSvc, AssetDir: assetDir, CustomerScope: customerFulfillmentSvc, CustomerMall: customerPortalSvc})
