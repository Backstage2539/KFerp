...
func defaultRoles() []roleSeed {
	...
	return []roleSeed{
		...
		{Code: "warehouse", Name: "仓库", Description: "库存和物料维护", Permissions: []string{"stock.read", "stock.write", "materials.read", "materials.write", "products.read"}},
		{Code: "finance", Name: "财务", Description: "订单、库存、报价和成本核算查看", Permissions: []string{"orders.read", "stock.read", "products.read", "costing.read"}},
