...
func TestDefaultViewPermissionsCoverVueShellMenuKeys(t *testing.T) {
	...
	for _, key := range []string{
		...
		"costingSettings", "machines", "companyProfile", "salesOrderSettings", "senderSettings", "outsourceSettings", "customerPortalSettings", "customerPortalManual", "customerFulfillment", "customerFulfillmentManual", "settingsAuditManual",
