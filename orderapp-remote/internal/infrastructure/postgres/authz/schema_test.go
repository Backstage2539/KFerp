...
func TestDefaultViewPermissionsCoverVueShellMenuKeys(t *testing.T) {
	...
	for _, key := range []string{
		...
		"productSettings", "mallSettings", "bom", "products", "costing",
		"costingSettings", "machines", "companyProfile", "salesOrderSettings", "senderSettings", "outsourceSettings", "customerPortalSettings", "customerFulfillment",
