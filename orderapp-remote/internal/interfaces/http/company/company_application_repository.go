...
func (r postgresCompanyRepository) ListDepartments(ctx context.Context) ([]companyapp.Department, error) {
...
func (r postgresCompanyRepository) CreateDepartment(ctx context.Context, cmd companyapp.DepartmentCommand) (int64, error) {
	var id int64
...
func (r postgresCompanyRepository) UpdateDepartment(ctx context.Context, id int64, cmd companyapp.DepartmentCommand) error {
...
func (r postgresCompanyRepository) ListEmployees(ctx context.Context, departmentID int64) ([]companyapp.Employee, error) {
	args := []any{}
	where := ""
	if departmentID > 0 {
...
func (r postgresCompanyRepository) CreateEmployee(ctx context.Context, cmd companyapp.EmployeeCommand) (int64, error) {
	var id int64
...
func (r postgresCompanyRepository) UpdateEmployee(ctx context.Context, id int64, cmd companyapp.EmployeeCommand) error {
