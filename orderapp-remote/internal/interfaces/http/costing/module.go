...
type Service interface {
	...
	ListBeanListPublicationSummaries(context.Context, appcosting.BeanListPublicationSummaryQuery) (appcosting.BeanListPublicationSummaryPage, error)
	LoadBeanListPublication(context.Context, appcosting.BeanListPublicationQuery, int64) (*appcosting.BeanListPublication, error)
	ListBeanListPriceSources(context.Context, appcosting.BeanListPublicationQuery) ([]appcosting.BeanListPublication, error)
	PreviewDeleteBeanListPublications(context.Context, appcosting.DeleteBeanListPublicationsPreviewCommand) (appcosting.DeleteBeanListPublicationsPreview, error)
	DeleteBeanListPublications(context.Context, appcosting.DeleteBeanListPublicationsCommand) (appcosting.DeleteBeanListPublicationsResult, error)
