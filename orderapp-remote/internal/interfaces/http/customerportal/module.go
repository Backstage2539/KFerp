...
type EmployeeSales interface {
	...
	ListDeliveryNoteDocuments(context.Context, int64) ([]salesapp.DeliveryNoteDocument, error)
	LoadSalesOrderDocumentFile(context.Context, int64, int64, bool) (salesapp.SalesOrderDocumentFile, error)
	LoadSalesOrderImageFile(context.Context, int64, int64, bool) (salesapp.SalesOrderImageFile, error)
	LoadDeliveryNoteDocumentFile(context.Context, int64, int64, bool) (salesapp.DeliveryNoteDocumentFile, error)
	LoadDeliveryNoteImageFile(context.Context, int64, int64, bool) (salesapp.DeliveryNoteImageFile, error)
	GenerateSalesOrderDocument(context.Context, salesapp.GenerateSalesOrderDocumentCommand) (salesapp.GenerateSalesOrderDocumentResult, error)
	GenerateSalesOrderImage(context.Context, salesapp.GenerateSalesOrderImageCommand) (salesapp.GenerateSalesOrderImageResult, error)
	GenerateDeliveryNoteDocument(context.Context, salesapp.GenerateDeliveryNoteDocumentCommand) (salesapp.GenerateDeliveryNoteDocumentResult, error)
