...
func TestDecideDeduction_InsufficientForbidden(t *testing.T) {
...
func TestDecideDeduction_BelowWarningAllowedWithPrompt(t *testing.T) {
...
func TestDecideDeduction_NormalAllowedNoWarning(t *testing.T) {
