...
func (r *fakeManufacturingGapRepo) UpdateJobCardMetrics(ctx context.Context, cmd productionapp.UpdateJobCardMetricsCommand) (productionapp.JobCardRow, error) {
	return productionapp.JobCardRow{ID: cmd.ID}, nil
}
