...
func TestOrderAPIFormReturnsPublishedGreenBeanListTiersForGreenBeanProduct(t *testing.T) {
	...
	mustExecOrderAPITestSQL(t, ctx, pool, fmt.Sprintf(`
		...
		VALUES
			...
			'{"groups":[{"items":[{"productId":88,"name":"曲奇拼配2.0","green_bean_sale_tiers":[{"label":"1KG","spec_g":1000,"min_qty":1,"max_qty":59,"price_per_unit":63.9,"price_per_lb":28.99,"template_id":5,"template_tier_id":50,"display_unit":"kg"},{"label":"60kG","spec_g":1000,"min_qty":60,"price_per_unit":63.9,"price_per_lb":28.99,"template_id":5,"template_tier_id":51,"display_unit":"kg"}]}]}]}'::jsonb,
	...
	if green.Tiers[0].ID != 50 || green.Tiers[0].SpecG != 1000 || green.Tiers[0].MinQty != 1 || green.Tiers[0].MaxQty == nil || *green.Tiers[0].MaxQty != 59 || green.Tiers[0].UnitPrice != 28.99 {
	...
	if green.Tiers[1].ID != 51 || green.Tiers[1].MinQty != 60 || green.Tiers[1].UnitPrice != 28.99 {
