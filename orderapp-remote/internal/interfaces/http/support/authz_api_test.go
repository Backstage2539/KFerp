...
func TestProductionConfigurationAPIPermissionsSeparateReadAndWrite(t *testing.T) {
	for _, tc := range []struct {
		...
		{http.MethodGet, "/api/production-bom-spec-templates", "bom.read"},
		{http.MethodPost, "/api/production-bom-spec-templates", "bom.write"},
		{http.MethodPut, "/api/production-bom-spec-template-versions/103/draft", "bom.write"},
		{http.MethodPost, "/api/production-bom-spec-template-versions/103/publish", "bom.write"},
		...
		{http.MethodGet, "/api/products/7/bom-spec-migration", "products.read"},
		{http.MethodPost, "/api/products/7/bom-spec-migration/cutover", "products.write"},
		{http.MethodGet, "/api/products/7/bom-spec-options", "products.read"},
		{http.MethodGet, "/api/product-bom-spec-migrations/7", "products.read"},
		{http.MethodPost, "/api/product-bom-spec-migrations/7/cutover", "products.write"},
		{http.MethodPost, "/api/product-business-identities/resolve", "products.write"},
