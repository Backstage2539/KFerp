...
func TestDev338OrderNoticePaymentHintSeeds(t *testing.T) {
	src := string(readOrderAppFileForTest(t, filepath.Join("internal", "interfaces", "http", "support", "req_store.go")))
	for _, want := range []string{
		"PR-338-ORDER-NOTICE-DEDUP-PAYMENT-HINT",
		"DEV-338-ORDER-NOTICE-DEDUP-PAYMENT-HINT",
		"UT-338-ORDER-NOTICE-DEDUP-PAYMENT-HINT",
		"API-338-ORDER-NOTICE-DEDUP-PAYMENT-HINT",
		"REV-338-ORDER-NOTICE-DEDUP-PAYMENT-HINT",
	} {
...
func TestDev338OrderNoticePaymentHintWiring(t *testing.T) {
...
func TestDev338OrderNoticePaymentHintDocs(t *testing.T) {
