...
func TestDev342SkuBomJumpFocusFilterRequirementSeeds(t *testing.T) {
	src := string(readOrderAppFileForTest(t, filepath.Join("internal", "interfaces", "http", "support", "req_store.go")))
	for _, want := range []string{
		"PR-342-SKU-BOM-JUMP-FOCUS-FILTER",
		"DEV-342-SKU-BOM-JUMP-FOCUS-FILTER",
		"UT-342-SKU-BOM-JUMP-FOCUS-FILTER",
		"API-342-SKU-BOM-JUMP-FOCUS-FILTER",
		"REV-342-SKU-BOM-JUMP-FOCUS-FILTER",
	} {
...
func TestDev342SkuBomJumpFocusFilterWiring(t *testing.T) {
	checks := []struct {
		rel     string
		markers []string
	}{
...
func TestDev342SkuBomJumpFocusFilterDocs(t *testing.T) {
