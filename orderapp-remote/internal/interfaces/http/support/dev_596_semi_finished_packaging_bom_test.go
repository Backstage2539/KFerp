...
func TestDev596SemiFinishedPackagingBomContracts(t *testing.T) {
	for rel, wants := range map[string][]string{
		...
		filepath.Join("internal", "interfaces", "http", "support", "req_store.go"): {
			"PR-597-SEMI-FINISHED-PACKAGING-BOM",
			"DEV-597-BOM-KIND-EXTENSION",
			"DEV-597-PRODUCT-SEMI-FINISHED",
			"DEV-597-SPEC-PACKAGING-REF",
			"DEV-597-VALIDITY-CHECK",
			"DEV-597-WORK-ORDER-DEPENDENCY",
			"DEV-597-TWO-STAGE-PLANNING",
			"DEV-597-COST-CALCULATION",
			"DEV-597-FRONTEND",
			"DEV-597-AUDIT-COMPAT",
		},
	} {
