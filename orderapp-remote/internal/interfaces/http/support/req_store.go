...
func seedReqWorkflowA(ctx context.Context, pool *pgxpool.Pool, schema string) error {
	...
	for _, row := range []reqSeedRow{
		...
		{table: "req_product", code: "PR-FIN-001", title: "新增月度经营结账中心：老板看本月利润税费并生成月度经营报告", status: "todo", assignee: "VA", evidence: "docs/superpowers/specs/2026-05-02-finance-monthly-closing-design.md"},
		{table: "req_dev", code: "DEV-FIN-001", title: "新增财务设置：企业类型、纳税人类型、申报周期、税率参数、强锁账模式和白名单切换配置", status: "todo", assignee: "Codex", evidence: "预计 2-3 个工作日"},
		{table: "req_dev", code: "DEV-FIN-002", title: "新增 finance DDD 模块和月结数据模型：月报快照、金额调整、税费确认、审计记录", status: "todo", assignee: "Codex", evidence: "预计 3-4 个工作日"},
		{table: "req_dev", code: "DEV-FIN-003", title: "实现月度经营汇总服务：从订单、库存出库、生产/加工成本、费用汇总收入成本费用", status: "todo", assignee: "Codex", evidence: "预计 3-4 个工作日"},
		{table: "req_dev", code: "DEV-FIN-004", title: "实现费用管理 API 和 Vue 页面，支持费用分类、归属期间费用或主营成本", status: "todo", assignee: "Codex", evidence: "预计 2-3 个工作日"},
		{table: "req_dev", code: "DEV-FIN-005", title: "实现月度结账流程：异常检查、默认强锁账、白名单切换、结账后金额调整", status: "todo", assignee: "Codex", evidence: "预计 3-4 个工作日"},
		{table: "req_dev", code: "DEV-FIN-006", title: "实现中等深度税费估算：小规模/一般纳税人增值税、附加税、小型微利企业所得税", status: "todo", assignee: "Codex", evidence: "预计 3-4 个工作日"},
		{table: "req_dev", code: "DEV-FIN-007", title: "实现财务首页和月度经营报告 Vue 页面：老板简报默认展示，明细 Tab 下钻", status: "todo", assignee: "Codex", evidence: "预计 3-4 个工作日"},
		{table: "req_dev", code: "DEV-FIN-008", title: "实现月度经营报告 PDF 和 Excel 导出，PDF 面向老板，Excel 面向财务/代账", status: "todo", assignee: "Codex", evidence: "预计 2-3 个工作日"},
		{table: "req_unit", code: "UT-FIN-001", title: "财务领域单测覆盖经营净利、毛利、强锁账、金额调整和小型微利企业税费估算", status: "todo", assignee: "Codex", evidence: "预计随 DEV-FIN-002/005/006 完成"},
		{table: "req_unit", code: "UT-FIN-002", title: "汇总服务单测覆盖烘焙厂、咖啡贸易商、壳豆加工厂不同主营成本来源", status: "todo", assignee: "Codex", evidence: "预计随 DEV-FIN-003 完成"},
		{table: "req_unit", code: "UT-FIN-003", title: "前端源码守卫覆盖财务首页、月报老板简报、明细 Tab、白名单高级开关", status: "todo", assignee: "Codex", evidence: "预计随 DEV-FIN-007 完成"},
		{table: "req_api", code: "API-FIN-001", title: "财务设置和财务首页接口返回企业类型、纳税人类型、月度指标和异常提醒", status: "todo", assignee: "Codex", evidence: "预计随 DEV-FIN-001/007 完成"},
		{table: "req_api", code: "API-FIN-002", title: "费用管理接口支持创建、查询、分类和归属费用", status: "todo", assignee: "Codex", evidence: "预计随 DEV-FIN-004 完成"},
		{table: "req_api", code: "API-FIN-003", title: "月度结账接口支持生成草稿、确认结账、强锁账校验和金额调整", status: "todo", assignee: "Codex", evidence: "预计随 DEV-FIN-005 完成"},
		{table: "req_api", code: "API-FIN-004", title: "税费估算和确认接口支持小规模、一般纳税人和小型微利企业所得税估算", status: "todo", assignee: "Codex", evidence: "预计随 DEV-FIN-006 完成"},
		{table: "req_api", code: "API-FIN-005", title: "月度经营报告接口支持老板简报、明细查询、PDF 和 Excel 导出", status: "todo", assignee: "Codex", evidence: "预计随 DEV-FIN-007/008 完成"},
		{table: "req_review", code: "REV-FIN-001", prCode: "PR-FIN-001", title: "验收：月度经营结账中心可查看利润税费、默认强锁账、可调整、可导出 PDF 和 Excel", status: "todo", assignee: "VA", evidence: "待实现后按设计文档和接口证据验收"},
	} {
