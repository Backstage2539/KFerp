...
func seedReqWorkflowA(ctx context.Context, pool *pgxpool.Pool, schema string) error {
	...
	for _, row := range []reqSeedRow{
		...
		{table: "req_review", code: "REV-160-01", prCode: "PR-160", title: "验收：选择誉观山咖啡后能看到数据面板；代加工工单 tab 只应用代加工批次；错误行和应用预览在 ERP 页面可见", status: "review", assignee: "VA", evidence: "OP_MANUAL_CUSTOMER_FULFILLMENT.md；待浏览器验收和 Van ERP 后台验收"},
