...
func seedReqWorkflowA(ctx context.Context, pool *pgxpool.Pool, schema string) error {
	...
	for _, row := range []reqSeedRow{
		...
		{table: "req_dev", code: "DEV-157-04", title: "Vue/Vite 客户履约账户工作台：按客户上传 Excel、解析校验、应用批次、查看库存/工单/代发/费用/结算", status: "done", assignee: "Codex", evidence: "CustomerFulfillmentView.vue; menu key customerFulfillment; /api/customer-fulfillment wrappers; customer-fulfillment-user-manual.md"},
