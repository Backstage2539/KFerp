...
func seedReqWorkflowA(ctx context.Context, pool *pgxpool.Pool, schema string) error {
	...
	for _, row := range []reqSeedRow{
		...
		{table: "req_dev", code: "DEV-DOCS-004", title: "Vue/Vite 新增通用操作手册视图，按菜单 key 读取 OP_MANUAL_*.md，并把订单、生产、库存、成本、财务、设置、客户履约和需求手册挂入对应大功能菜单", status: "done", assignee: "Codex", evidence: "OperationManualView.vue; operation-manuals.js; menu-ia.js"},
		{table: "req_dev", code: "DEV-DOCS-005", title: "合并旧 *-user-manual.md 内容到大功能 OP_MANUAL_*.md，删除旧功能手册和旧单独 Vue 手册组件", status: "done", assignee: "Codex", evidence: "OP_MANUAL_ORDER_SALES.md; OP_MANUAL_PRODUCTION.md; OP_MANUAL_FINANCE.md; OP_MANUAL_CUSTOMER_FULFILLMENT.md"},
